...
def create_database():
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=postgres user={} password={}".format(*config['DATABASE'].values()))
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user={} password={}".format(*config['DATABASE'].values()))
    cur = conn.cursor()
