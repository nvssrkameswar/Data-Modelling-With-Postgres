...
songplay_table_insert = ("""INSERT INTO fact_songplays VALUES (DEFAULT, %s, %s, %s, %s, %s, %s, %s, %s )
""")
...
time_table_insert = ("""INSERT INTO dim_time VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT (start_time) DO NOTHING
""")

# FIND SONGS

song_select = ("""
    SELECT song_id, dim_artists.artist_id
    FROM dim_songs JOIN dim_artists ON dim_songs.artist_id = dim_artists.artist_id
